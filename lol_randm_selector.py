import random
#This program can create a list of random champs, you can modify the quantity of champs through the range("x"). Have fun :D
...
# take out of the list the chosen champ .split() or .remove()
